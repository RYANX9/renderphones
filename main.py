...
from app.routes.tradein import router as tradein_router
from app.routes.feedback import router as feedback_router   # add this
...
app.include_router(feedback_router)   # add this
